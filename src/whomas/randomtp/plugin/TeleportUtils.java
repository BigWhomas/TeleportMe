...
public class TeleportUtils {
	...
	public TeleportUtils(TeleportMe plugin) {
	...
	public static Location generateLocation(Player player) {
		...
		if (configGetter.getConfig().getBoolean("CustomDistance")) { // If they want to limit the distance

			x = random.nextInt(configGetter.getConfig().getInt("MaxDistance"));

			z = random.nextInt(configGetter.getConfig().getInt("MaxDistance"));

			y = 150;

		} else if (!configGetter.getConfig().getBoolean("CustomDistance")) { // If they dont
